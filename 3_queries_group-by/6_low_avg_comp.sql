...
AVG(assignment_submissions.durations) as average_assignment_duration,
AVG(assignments.durations) as average_estimated_duration
FROM assignment_submissions
JOIN students ON students.id = student_id
JOIN assignments ON assignments.id = assignment_id
WHERE end_date IS NULL
GROUP BY student
ORDER BY average_assignment_duration, average_estimated_duration ASC;
